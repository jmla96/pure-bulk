...
@section('contenido')
    ...
    <div class="col-xs-12 push-50-t">
        ...
        <div class="col-lg-3 push-30-t col-md-offset-1 col-xs-12 text-justify">
            <p>
                La <i>glutamina</i> <strong>PURE BULK </strong> se presenta en un polvo de grado farmacéutico
                100% puro. La <i>glutamina</i> es uno de
                los suplementos nutritivos deportivos más populares del mundo, principalmente por la gran variedad de
                beneficios que este aporta al deportista.
            </p>
            <p>
                Se trata del aminoácido más abundante del tejido muscular que el organismo produce naturalmente. Pese a
                ello y a su presencia en ciertos alimentos, como la carne y el pescado, esta cantidad no es suficiente
        ...
        <div class="col-lg-3 center-b push-50-t text-left col-md-6 col-xs-12 col-md-offset-3 col-md-offset-0">
            ...
            <br> <br>
            <button class="btn btn-rounded bg-white border col-xs-12">- Apta para <br> Vegetarianos y vegetarianos <br>estrictos.
            </button>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="col-xs-12 col-md-10 col-sm-offset-1 text-justify push-15-t">
            <p>
                ...
                fin de
                reforzar el sistema inmunitario y prevenir la atrofia muscular producto de la inactividad.
            </p>
            <p>
            ...
            <p>
                Acompañar la <i>glutamina</i> de un hidrato de carbono de rápida acción, como el almidón de maíz ceroso,
                puede
                contribuir a agilizar el transporte de <i>glutamina</i> a las células musculares. Esta combinación es
                ideal
                para después de hacer ejercicio, cuando los músculos necesitan aminoácidos.
            </p>
            <p>
                La <i>glutamina</i> se complementa con muchos otros productos: desde otros aminoácidos, como los BCAA de
            ...
            <p>
                Al igual que con todos los productos de <strong>Pure Bulk</strong> este producto se obtiene directamente
                de proveedor
                ...
                todos los productos de <strong>Pure Bulk</strong> son envasados en nuestras propias bodegas. Todo esto
                se combina para
