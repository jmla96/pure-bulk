...
<div class="col-xs-12 padding50px padding60px">
    <div class="col-xs-12  ">
        <div class="col-md-4 col-xs-12">
            ...
            <p class="margin-top10px text-justify">
...
<div class="col-xs-12 bgeight padding50px pbottom100px">
    <h2 class="center-b text-white h1"><b>Todos los productos de Pure Bulk</b></h2>

    <div class="col-sm-6 margin-top50px bg-white text-black-op padding50px col-sm-offset-3 bradiusone shadow1">
        <h3 class="center-b">CREATINE MONOHYDRATE 1 KILO</h3>
        <div class="col-md-4 col-xs-12 center-b">
            <img src="{{url('assets/img/creatine.jpg')}}" class="width200px center-b">
        </div>
        <div class="col-md-7 margin-top20px center-b col-xs-12 col-sm-offset-1 col-md-offset-0">
            ...
            <div class="col-xs-1">
                <button class="btn bgseven text-white floatleft">COMPRAR</button>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 margin-top50px bg-white text-black-op padding50px col-sm-offset-3 bradiusone shadow1">
        ...
        <div class="col-md-4 col-xs-12 center-b">
            <img src="{{url('assets/img/glutamine.jpg')}}" class="width200px center-b">
        </div>
        <div class="col-md-7 margin-top20px center-b col-xs-12 col-sm-offset-1 col-md-offset-0">
    ...
    <div class="col-sm-6 margin-top50px bg-white text-black-op padding50px col-sm-offset-3 bradiusone shadow1">
        ...
        <div class="col-md-4 col-xs-12 center-b">
            <img src="{{url('assets/img/pure-bulk.jpg')}}" class="width200px center-b">
        </div>
        <div class="col-md-7 margin-top20px center-b col-xs-12 col-sm-offset-1 col-md-offset-0">
