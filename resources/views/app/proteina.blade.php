...
@section('contenido')
    ...
    <div class="col-xs-12 push-50-t">
        ...
        <div class="col-lg-3 center-b push-50-t text-left col-sm-6 col-xs-12 col-md-offset-3 col-md-offset-0">
            <button class="btn btn-rounded bg-white border col-xs-12 push-10-t"> - 0 gramos de carbohidratos</button>
            <button class="btn btn-rounded bg-white border col-xs-12 push-10-t">- menos de 0,1 gramos de <br> grasa por porción</button>
            <button class="btn btn-rounded bg-white border col-xs-12 push-10-t">- más de 29 gramos de proteína <br>por 30 gramos de porción </button>
            <button class="btn btn-rounded bg-white border col-xs-12 push-10-t">- más del 12% de leucina y 50% <br>de aminoácidos esenciales </button>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-justify push-15-t">
            ...
            <p><i>100% Whey Protein Isolated</i> de <strong>pure bulk</strong> es la proteína de suero aislada de más alta calidad disponible en
                el mercado. 0 gramos de carbohidratos y menos de 0,1 gramos de grasa por porción. <i>100% Whey Protein
                Isolated</i> de <strong>pure bulk</strong> contiene más de 26.4 gramos de proteína por 30 gramos de porción y se compone de
                más del 12% de leucina y 50% de aminoácidos esenciales. Uno de los aspectos más importantes de <i>100% Whey
                Protein Isolated</i> de <strong>pure bulk</strong> es que se compone mayoritariamente de a-lactoalbumina y ß-lactoglobulina,
            ...
            <p>Si usted está buscando la proteína whey más pura y de mayor calidad en existencia, ya conoce <i>100% Whey
                Protein Isolated</i> sin azúcar, soya, levadura, gluten, colorantes, saborizantes, solo proteína de suero
                aislada pura!
            </p>
        </div>
    </div>
